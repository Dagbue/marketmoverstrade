  ...
  <div>
    ...
    <dialog open>
      ...
      <div>
        ...
        <p>Market Movers Trade ("Website"), which includes all products and services offered by Market Movers Trade,
          is and remains the sole property of the Company. All rights are reserved in and for the Company Market Movers Trade
          group is the owner of all the intellectual property rights, including trade names, trademarks, logos
          and the trade names in and are exclusive to Market Movers Trade at all times. Except where expressly stated
          ...
          any materials or media from the Website, without obtaining prior written permission from Market Movers Trade
          Group.</p>
      </div>
      <div>
        <h4>Data</h4>
      ...
      <div>
        <h4>Amendments</h4>
        <p>Market Movers Trade has the right to amend the Agreement without obtaining any prior consent from the Client.
